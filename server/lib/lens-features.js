...
const _FEATURES = {
  ...
  docs: {
    ...
    category: "PLATFORM",
    features: [
      f("rich_editor", "Rich Block Editor", "Tiptap-powered block editor with 22 slash commands (headings, lists, code blocks, tables, task lists)", "creation", []),
      f("page_tree", "Page Hierarchy", "Nested page tree with drag-to-reparent and cycle detection", "creation", []),
      f("real_time_collab", "Multi-Cursor Collaboration", "Real-time presence, cursors, and selection broadcasts (last-write-wins)", "collaboration", []),
      f("comments_threads", "Comments + Threads", "Selection-anchored comments with threading, reactions, and resolve", "collaboration", []),
      f("version_history", "Version History", "Time-travel with auto + manual snapshots, restore creates pre-restore snapshot", "infrastructure", []),
      f("sharing_permissions", "Sharing + 5-Tier Roles", "owner / admin / editor / commenter / viewer with public publish via slug", "collaboration", []),
      f("backlinks", "Bidirectional Backlinks", "Auto-extracted from doc:/dtu: hrefs; incoming + outgoing panels", "infrastructure", ["dtu"]),
      ...
      f("workspace_search", "Workspace Search", "Substring search across title + markdown body of all my docs", "infrastructure", []),
      f("readability_scoring", "Readability Scoring", "Flesch-Kincaid, Gunning Fog, Coleman-Liau, SMOG", "analysis", []),
      f("dtu_cite", "Cross-Lens DTU Cite", "Inline DTU links + embeds with royalty cascade on reuse", "marketplace", ["citation_royalties"]),
    ],
    featureCount: 12,
    economicIntegrations: ["dtu", "dtu_marketplace", "citation_royalties"],
    emergentAccess: true,
    botAccess: true,
    usbIntegration: false,
  },
