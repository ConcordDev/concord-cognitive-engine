...
`grep -c 'registerLensAction("hr"' server/domains/hr.js` → **56**
...
**Coverage: 20 of 23 checklist items ALREADY REAL, 0 BACKEND-CAPABLE-BUT-UNSURFACED (everything real was already surfaced), 3 GENUINELY MISSING with explicit honest dispositions (no fabrication in their place).**
