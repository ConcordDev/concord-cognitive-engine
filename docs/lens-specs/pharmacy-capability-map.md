...
| 7 | Doctor-appointment manager / calendar | **GENUINELY MISSING — DEFERRED-SCOPED-BUILD** | No appointment/calendar macro exists in `pharmacy.js`; would need a new table + macro set, out of scope for a frontend rebuild |
