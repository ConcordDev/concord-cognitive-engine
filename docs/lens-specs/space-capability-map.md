...
| Ground-station pass scheduling for own satellites | GENUINELY MISSING | Deferred — no user-owned-satellite substrate exists; out of scope for a UI-polish batch |
