...
export const metadata: Metadata = {
  ...
  description:
    'A sovereign knowledge operating system. No ads. No subscriptions. No data extraction. Free. 236+ domain lenses, local-first AI. Your thoughts never leave your control.',
  keywords: [
    'cognitive engine',
    'knowledge OS',
    'sovereign AI',
  ...
  openGraph: {
    ...
    description:
      "No ads. Ever. No subscriptions. No data extraction. Free. A sovereign cognitive engine with 236+ domain lenses and local-first AI. Not a promise — it's architecture.",
    images: [
      {
        url: '/og-image.png',
        width: 1200,
