...
export const metadata: Metadata = {
  ...
  description:
    'A sovereign knowledge operating system that grows with you. 236 domain lenses, DTU-based memory, lattice governance, local-first AI. No ads, no extraction, no surveillance.',
  alternates: {
    canonical: '/',
  },
};
        ...
        <main className="px-8 pt-20 pb-32 max-w-6xl mx-auto">
          ...
          <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-20">
            <div className="bg-lattice-surface border border-lattice-border rounded-xl p-6">
              <h3 className="text-lg font-semibold text-white mb-2">236 Domain Lenses</h3>
