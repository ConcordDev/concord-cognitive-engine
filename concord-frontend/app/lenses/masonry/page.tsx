...
export default function MasonryLensPage() {
  ...
  const { items, isLoading, isError, error, refetch, create, update, remove } =
    useLensData<TradeArtifact>('masonry', activeArtifactType, { seed: [] });
  ...
  return (
    ...
    >
      ...
      {(() => {
        ...
        const materialsUsed = [...new Set(all.map((a) => a.material).filter(Boolean))].length;
        ...
        return (
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className={ds.panel}>
              ...
              <p className={ds.textMuted}>Materials Used</p>
              <p className="text-xl font-bold text-white">{materialsUsed}</p>
            </div>
            <div className={ds.panel}>
