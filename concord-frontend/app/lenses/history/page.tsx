...
export default function HistoryLensPage() {
  ...
  useLensCommand(
    ...
    [
      ...
      { id: 'tab-timeline', keys: 't', description: 'Timeline', category: 'navigation', action: () => setActiveTab('Timeline') },      { id: "focus-search", keys: "/", description: "Focus search", category: "navigation", action: () => searchInputRef.current?.focus() },
