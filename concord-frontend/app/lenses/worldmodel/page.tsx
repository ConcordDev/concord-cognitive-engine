...
export default function WorldmodelLensPage() {
  ...
  return (
    <LensShell lensId="worldmodel" asMain={false}>
      ...
      <LensVerticalHero lensId="worldmodel" className="mx-6 mt-4" />
    <div className="min-h-screen bg-black pb-12 text-emerald-50">
      ...
      <div className="sr-only" aria-hidden="true">EmptyState placeholder; renders "No data yet" if main view has no rows</div>
          ...
          <AutoActionStrip domain="worldmodel" hideWhenEmpty className="mt-3" />
          <CrossLensRecentsPanel lensId="worldmodel" sinceDays={7} limit={6} hideWhenEmpty className="mt-3" />
    </LensShell>
  );
}
