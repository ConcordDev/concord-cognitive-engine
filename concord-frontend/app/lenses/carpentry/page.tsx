...
const TRADE_MATERIALS = ['Dimensional Lumber','Plywood','OSB','Hardwood','Trim/Molding','Drywall','Fasteners','Adhesives','Stain/Finish','Composite Decking','LVL Beams','Engineered Joists'];
const TRADE_CERTS = ['Journeyman Carpenter','Master Carpenter','Finish Carpenter','Framing Certification','Cabinet Making','OSHA 30'];

export default function CarpentryLensPage() {
  useLensNav('carpentry');
  const { latestData: realtimeData, isLive, lastUpdated, insights } = useRealtimeLens('carpentry');
