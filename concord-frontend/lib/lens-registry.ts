...
export const LENS_REGISTRY: LensEntry[] = [
  ...
  { id: 'gallery', name: 'Gallery', icon: Camera, description: 'Your shared photos', category: 'creative', showInSidebar: false, showInCommandPalette: true, path: '/lenses/gallery', order: 90, keywords: ['gallery', 'photo', 'image', 'share'] },
