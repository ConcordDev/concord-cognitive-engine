...
const QUERIES = [
  { id: 'all:chain+of+thought', label: 'chain-of-thought' },
  { id: 'all:reasoning+llm', label: 'reasoning + llm' },
  { id: 'all:tree+of+thoughts', label: 'tree-of-thoughts' },
  { id: 'cat:cs.LO', label: 'cs.LO (logic)' },
];
...
export function ReasoningArxiv() {
  const [q, setQ] = useState(QUERIES[0].id);

  const papers = useQuery({
    queryKey: ['arxiv-reasoning', q],
    queryFn: async () => {
