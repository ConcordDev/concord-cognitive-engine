                ...
                {book && (
                  <div>
                    <p className="mb-1 flex items-center gap-1 text-[11px] font-semibold uppercase tracking-wider text-gray-400">
                      <ListOrdered className="h-3 w-3" /> Order book depth · {book.restingCount} resting
                    </p>
                    <DepthChart yesBids={book.yesBids} noBids={book.noBids} midProbability={book.currentYesProbability} />
