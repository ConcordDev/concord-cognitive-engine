  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-2 text-[11px]">
        ...
        <div className="rounded border border-emerald-500/15 bg-emerald-500/5 p-2"><div className="text-[10px] uppercase tracking-wider text-zinc-500">Heartbeats</div><div className="font-mono text-zinc-100">{d.heartbeatsOk ? '✓ OK' : '—'}</div></div>
      </div>
