...
/**
 * BrowserPanel — paginated DTU vault browser + compute actions + live feed.
 * Macros: lineageAnalysis, qualityScore, citationNetwork, tierRecommendation,
...
export function BrowserPanel() {
  ...
  useLensCommand(
    [
      ...
      { id: 'tier-mega',    keys: 'shift+3', description: 'MEGA tier',     category: 'view', action: () => setTierFilter('mega') },
      { id: 'tier-hyper',   keys: 'shift+4', description: 'HYPER tier',    category: 'view', action: () => setTierFilter('hyper') },
    ],
    { lensId: 'dtus' }
  );
