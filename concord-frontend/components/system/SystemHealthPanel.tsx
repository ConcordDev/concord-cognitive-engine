  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-2 text-[11px]">
        ...
        <div className="rounded border border-emerald-500/15 bg-emerald-500/5 p-2"><div className="flex items-center gap-1 text-[10px] uppercase tracking-wider text-zinc-400"><Activity className="h-2.5 w-2.5" />Heartbeats</div><div className="font-mono text-zinc-100">{d.heartbeatsOk ? '✓ OK' : '—'}</div></div>
      </div>
