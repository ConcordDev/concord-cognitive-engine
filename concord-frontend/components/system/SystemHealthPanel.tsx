  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-2 sm:grid-cols-4">
        ...
        <div className="rounded border border-zinc-800 bg-zinc-950 px-2.5 py-1.5"><div className="flex items-center gap-1 text-[10px] uppercase tracking-wider text-zinc-500"><Zap className="h-2.5 w-2.5" />Uptime</div><div className="mt-0.5 font-mono text-lg text-emerald-300">{uptimeHrs}h</div></div>
      ...
      <div className="grid grid-cols-2 gap-2 text-[11px]">
        ...
        <div className="rounded border border-emerald-500/15 bg-emerald-500/5 p-2"><div className="flex items-center gap-1 text-[10px] uppercase tracking-wider text-zinc-500"><Activity className="h-2.5 w-2.5" />Heartbeats</div><div className="font-mono text-zinc-100">{d.heartbeatsOk ? '✓ OK' : '—'}</div></div>
      </div>
