...
/**
 * CasesPanel — Resolution Center case list extracted from the welded
 * disputes page. Owns my/queue list, create modal, seller/admin flows,
 * and AI analysis macros. Page shell routes here via active=cases.
 */
...
export function CasesPanel() {
  ...
  return (
    ...
    <div className={ds.pageContainer}>
      {/* Actions */}
      <div className={cn(ds.sectionHeader, 'justify-end')}>
