    ...
    <div className="bg-[#0d1117] border border-emerald-500/20 rounded-lg overflow-hidden">
      ...
      <div className="max-h-80 overflow-y-auto">
        {loading ? (
          ...
          <div className="px-3 py-10 text-center text-xs text-gray-500"><Layers className="w-6 h-6 mx-auto mb-2 opacity-30" />No zones yet.</div>
        ) : (
            ...
            {zones.map(z => (
              <li key={z.id} className="px-3 py-2 hover:bg-white/[0.03] group flex items-center gap-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-[10px] text-gray-500">Field {z.fieldId.slice(0, 10)} · {z.soilType} · {z.areaAcres}ac</div>
                </div>
