    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
        ...
        {all.length === 0 && !load.isPending && (
          <div className="col-span-full rounded border border-dashed border-zinc-800 p-6 text-center text-[11px] text-zinc-500">Pick a firm above to load real reference data.</div>
        )}
      </div>
    </div>
  );
