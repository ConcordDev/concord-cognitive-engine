        ...
        {active ? (
          <div className="bg-[#0d1117] border border-cyan-500/15 rounded-lg overflow-hidden">
            <header className="px-4 py-2.5 border-b border-white/10 flex items-center gap-2">
              ...
              {isSigned ? (
                <span className="ml-auto text-[10px] text-emerald-300 inline-flex items-center gap-1"><CheckCircle className="w-3.5 h-3.5" /> signed {active.signedAt?.slice(0, 10)}</span>
              ) : (
