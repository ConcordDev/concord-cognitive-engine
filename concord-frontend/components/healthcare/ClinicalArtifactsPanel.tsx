...
/**
 * ClinicalArtifactsPanel — artifact-ops desk extracted from the former
 * welded healthcare/page.tsx. Owns useLensData('healthcare','artifact')
 * plus legacy runArtifact macros (checkInteractions, protocolMatch,
 * generateSummary, exportEncounter, soapAutoFill) and generate care-plan.
 * Portal ModeTabs (MyChart / SymptomAI / Meds / Appts / Rx / Providers)
 * remain reachable inside this panel, folded into the clinical-ops IA.
 */
...
import { VitalGauge, StatusBadge, calculateBMI, calculateDaysRemaining, calculateVisitDuration, isOutOfRange, getTrend, getVitalColor, getVitalBg, isVitalCritical } from '@/components/healthcare/HealthcareVitals';
...
type MedFilter = 'all' | 'scheduled' | 'prn';
type FormPriority = 'low' | 'medium' | 'high' | 'urgent';
...
export function ClinicalArtifactsPanel() {
  ...
  const [formPriority, setFormPriority] = useState<FormPriority>('medium');
    ...
    >
      ...
      <header className={ds.sectionHeader}>
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              <h1 className="text-2xl font-bold text-blue-50">Records desk</h1>
            </div>
...
export default ClinicalArtifactsPanel;
