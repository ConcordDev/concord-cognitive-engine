...
import { Ticket, Plus, Trash2, Power, Calculator } from 'lucide-react';
...
export function CouponsPanel() {
  ...
  return (
    <div className="space-y-3">
      ...
      {/* Coupon tester */}
      <div className="bg-lattice-deep border border-white/10 rounded-lg overflow-hidden">
        ...
        <div className="px-4 py-3 grid grid-cols-12 gap-2 items-center">
          ...
          {testResult && (
            <div className="col-span-12 text-xs text-emerald-200 flex items-center gap-3 tabular-nums">
              <span>
