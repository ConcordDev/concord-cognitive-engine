...
/**
 * Import desk — Universal drop + structured ETL + job history + row analysis.
 * Restore / parity / tooling live as sibling tabs on the thin page shell.
 */
...
export function ImportDeskPanel() {
