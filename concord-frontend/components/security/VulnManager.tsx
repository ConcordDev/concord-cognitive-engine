  ...
  return (
    <div className="rounded-2xl border border-zinc-800 bg-zinc-950/60 p-4">
      <div className="flex items-center gap-2 mb-3">
        ...
        <span className="text-[11px] text-zinc-500">OpenCVE shape</span>
      </div>
      ...
      <div className="grid sm:grid-cols-2 gap-3">
        {/* Assets */}
        <div>
          <p className="text-[10px] uppercase tracking-wide text-zinc-500 mb-1">Asset inventory</p>
          ...
          <ul className="space-y-1 max-h-48 overflow-y-auto">
            {assets.map(a => (
              <li key={a.id} className="group flex items-center gap-2 bg-zinc-900/60 border border-zinc-800 rounded px-2 py-1">
                <span className="text-xs text-zinc-200 flex-1 truncate">{a.name} <span className="text-zinc-500">{a.vendor || a.type}</span></span>
        ...
        <div>
          <div className="flex items-center justify-between mb-1">
            <p className="text-[10px] uppercase tracking-wide text-zinc-500">Vulnerabilities</p>
