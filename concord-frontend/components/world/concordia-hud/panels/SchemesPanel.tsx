...
export function SchemesPanel() {
  ...
  return (
    <div className="text-sm">
      ...
      <h3 className="text-xs uppercase tracking-wider text-zinc-500 mb-2">Against you ({against.length})</h3>
      {against.length === 0 ? <p className="text-zinc-500 text-xs italic">None detected.</p> : (
