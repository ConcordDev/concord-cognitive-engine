...
export function DynastyPanel() {
  ...
  if (!dyn) return (
    <div className="text-sm">
      <h3 className="text-xs uppercase tracking-wider text-zinc-400 mb-2">Found a house</h3>
  ...
  return (
    <div className="text-sm">
      ...
      <dl className="grid grid-cols-2 gap-1 text-xs mb-3">
        <dt className="text-zinc-400">Head</dt><dd className="text-zinc-200 font-mono truncate">{dyn.current_head_user_id}</dd>
        <dt className="text-zinc-400">Renown</dt><dd className="text-amber-300">{dyn.renown} / 1000</dd>
        <dt className="text-zinc-400">Generation</dt><dd className="text-zinc-200">{dyn.generations}</dd>
      </dl>
      {log.length > 0 && (
        <>
          <h4 className="text-xs uppercase tracking-wider text-zinc-400 mb-1">Succession</h4>
