...
export function MarriagePanel() {
  ...
  return (
    <div className="text-sm">
      <h3 className="text-xs uppercase tracking-wider text-zinc-400 mb-2">Active unions</h3>
      {mar.length === 0 ? <p className="text-zinc-400 text-xs italic mb-3">No marriages.</p> : (
      ...
      <h3 className="text-xs uppercase tracking-wider text-zinc-400 mb-2">Propose to NPC</h3>
