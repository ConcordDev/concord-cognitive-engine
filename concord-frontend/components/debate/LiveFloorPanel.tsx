...
/**
 * LiveFloorPanel — timed/oratory debate floor extracted from the welded
 * debate page. Owns phase machine, timer, pro/con desk, AI analysis
 * macros (evaluateArgument / steelmanPosition / scoreDebate / fallacyCheck),
 * and DebateActionPanel. Page shell routes here via active=floor.
 */
