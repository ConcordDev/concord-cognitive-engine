    ...
    <li className="bg-zinc-900/70 border border-zinc-800 rounded-xl p-3">
      <div className="flex items-start justify-between gap-2">
        <div className="min-w-0">
          ...
          <p className="text-[11px] text-zinc-500 truncate">{ep.showTitle} · {fmt(ep.durationSec)}</p>
        </div>
    ...
    <div className="space-y-4">
      ...
      <section>
        ...
        {continueList.length === 0 ? (
          <p className="text-[11px] text-zinc-500 italic">Nothing in progress.</p>
        ) : (
      ...
      <section>
        ...
        {newEps.length === 0 ? (
          <p className="text-[11px] text-zinc-500 italic">No new episodes. Subscribe to shows in the Browse tab.</p>
        ) : (
