...
export function WorldMarkers({
  ...
  const projected = useMemo<ProjectedMarker[]>(() => {
    ...
    return out;
  }, [markers, cameraPos, cameraPos.x, cameraPos.y, cameraPos.z, cameraForward, cameraForward.x, cameraForward.y, cameraForward.z, cameraUp, cameraUp.x, cameraUp.y, cameraUp.z, fov, visibilityRadius]);
