...
import {
  Satellite, Eye, Orbit, Timer, Rocket, Compass, Filter, Image as ImageIcon, Radar, Globe2,
} from 'lucide-react';
...
const TABS: { key: ObsTab; label: string; icon: typeof Satellite }[] = [
  ...
  { key: 'catalog', label: 'Satellite Catalog', icon: Globe2 },
