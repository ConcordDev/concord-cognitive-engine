  ...
  return (
    <div className="flex flex-col h-full bg-[#0d1117]">
      <header className="px-3 py-2 border-b border-white/10 flex items-center gap-2">
        ...
        <span className="ml-auto text-[10px] text-gray-400">{snippets.length}</span>
        <button
      ...
      {creating && (
        <div className="p-3 border-b border-white/10 space-y-2 bg-white/[0.02]">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-[10px] text-gray-400">{newCode.split('\n').length} lines</span>
          </div>
          <textarea
            value={newCode}
                ...
                <li key={s.id} className="border-b border-white/5">
                  <div className="px-3 py-2 hover:bg-white/[0.03] group">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[9px] text-gray-400 font-mono uppercase">{s.language}</span>
                      <button
