      ...
      <div className="flex items-center gap-1.5 mt-2">
        <button type="button" onClick={markRead}
          className={cn('flex items-center gap-1 px-2 py-1 text-[11px] rounded-lg',
            article.read ? 'bg-zinc-800 text-zinc-500' : 'bg-rose-600 hover:bg-rose-500 text-white')}>
        ...
        {article.url && (
          <a href={article.url} target="_blank" rel="noopener noreferrer"
            className="ml-auto flex items-center gap-1 px-2 py-1 text-[11px] text-zinc-500 hover:text-zinc-300">
