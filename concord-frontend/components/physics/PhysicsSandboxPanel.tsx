...
/**
 * PhysicsSandboxPanel — client-side Verlet playground (Algodoo-shaped).
 * Honest local integration; saved scenes persist via useLensData('physics','simulation').
 * Distinct from PhysicsLab (server-authoritative PhET scene editor).
 */
...
export function PhysicsSandboxPanel() {
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-400">
              Client Verlet lab — drag bodies, springs, force fields. Numbers on screen are the live integration.
            </p>
          </div>
        </div>
