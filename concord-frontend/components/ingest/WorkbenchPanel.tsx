...
/**
 * Ingest workbench — drop/paste/history + analysis macros.
 * Shares textInput between ingest submit and analysis actions (preserved).
  ...
  return (
    <div className="space-y-6">
      <header className="flex items-center gap-3">
        ...
        <div>
          <h2 className="text-lg font-bold">Drop &amp; paste</h2>
