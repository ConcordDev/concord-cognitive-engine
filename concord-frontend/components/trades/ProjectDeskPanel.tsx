...
export default function ProjectDeskPanel() {
    ...
    <div className={cn(ds.pageContainer, 'lens-trades')} data-lens-theme="trades">
      ...
      <header className={ds.sectionHeader}>
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              <h1 className={cn(ds.heading1, 'text-slate-100')}>Project desk</h1>
            </div>
            <p className={ds.textMuted}>Jobs, estimates, materials, permits, equipment, and clients</p>
          </div>
        </div>
        <div className="flex items-center gap-2">
          <VisionAnalyzeButton
