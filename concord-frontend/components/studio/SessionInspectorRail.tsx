              ...
              <div className="space-y-2">
                <label className="block">
                  ...
                  <input
                    ...
                    className="mt-1 w-full px-2 py-1 text-xs bg-black/40 border border-white/10 rounded text-zinc-200 placeholder:text-zinc-600 focus:outline-none focus:border-white/30"
                  />
                </label>
            ...
            <div>
              ...
              <ol className="space-y-1">
                ...
                {(selectedTrack.effectChain || []).length === 0 && (
                  <li className="px-2 py-2 text-[11px] text-zinc-600 border border-dashed border-white/10 rounded text-center">
                    No inserts
                  </li>
                )}
              </ol>
