  ...
  return (
    <aside className={cn('flex flex-col bg-zinc-900/60 border-r border-white/10 overflow-hidden', className)}>
      ...
      <div className="px-3 py-2 border-b border-white/10">
        <div className="text-[10px] uppercase tracking-wider text-zinc-500 mb-1.5">Browser</div>
        <div className="relative">
          ...
          <input
            ...
            placeholder="Search…"
            className="w-full pl-7 pr-2 py-1.5 text-xs bg-black/40 border border-white/10 rounded text-zinc-200 placeholder:text-zinc-600 focus:outline-none focus:border-white/30"
          />
        </div>
      </div>
          ...
          return (
            <button
              ...
              className={cn(
                ...
                isActive ? `${m.accent} border-current bg-white/[0.03]` : 'text-zinc-500 border-transparent hover:bg-white/[0.02]'
              )}
            >
      ...
      <div className="px-3 py-1.5 text-[10px] text-zinc-600 border-t border-white/10">
