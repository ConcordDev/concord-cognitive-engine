...
/**
 * SessionPlayerPanel — goal picker, timer, post-session actions, practice ledger.
 * Extracted from meditation/page.tsx. Studio tabs stay on the thin shell.
 */
...
export function SessionPlayerPanel({ practiceTick = 0 }: { practiceTick?: number }) {
  ...
  useEffect(() => {
    if (practiceTick > 0) notifyPractice();
