...
export function SovereigntyPanel({
  ...
  useLensCommand(
    [
      { id: 'open-setup',     keys: 's', description: 'Open sovereignty setup', category: 'actions', action: () => { setShowSovereigntySetup(true); onOpenSetup?.(); } },
  ...
  return (
    <div data-lens-theme="lock" className="space-y-6">
