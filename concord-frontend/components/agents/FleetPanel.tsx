...
/**
 * FleetPanel — Agent Control Center fleet desk.
 * Owns agent CRUD (useLensData), start/stop/executeRun (useRunArtifact),
 * listTaskDefinitions (lensRun), detail tabs, and the create modal.
 * Page shell owns the single active view union (fleet | roster | fork).
 */
...
import {
  Bot, Plus, Play, Power, Activity, Clock, Zap, Settings, Search, Terminal,
  ChevronRight, BarChart3, Code, Cpu, CheckCircle, XCircle, Database, Layers,
  TrendingUp, Trash2, Gauge, Route, Radio, Timer, Loader2, AlertTriangle
} from 'lucide-react';
...
import {
  ...
  type AgentRunResult,
  type TaskDefinition,
} from '@/components/agents/agents-model';
      ...
      <div className="flex items-center justify-end gap-2">
        {selectedAgent && (
          <button
            ...
            className="text-sm text-gray-400 hover:text-white flex items-center gap-1 mr-auto"
          >
