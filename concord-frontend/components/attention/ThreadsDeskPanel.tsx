...
/**
 * Threads desk — parallel reasoning threads, allocation, queue, and
 * create/complete mutations. Filter/sort live here (panel-owned), not as
...
import {
  Plus, Play, CheckCircle2, Layers, Clock, BarChart3,
  Sliders, Focus, Pause, AlertTriangle, ArrowUpDown,
  RefreshCw, Activity, Target, Cpu, Brain, Gauge,
} from 'lucide-react';
...
export function ThreadsDeskPanel() {
  const { latestData: realtimeData, insights: realtimeInsights, isLive, lastUpdated } = useRealtimeLens('attention');
