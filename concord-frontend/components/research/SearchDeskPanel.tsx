...
/**
 * Search desk — DTU full-text search, hypothesis/generate, deep research,
 * citation/methodology/reproducibility actions. Extracted from research/page.tsx.
 */
...
export function SearchDeskPanel() {
