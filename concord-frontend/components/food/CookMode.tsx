...
export function CookMode({ recipeTitle, servings, steps, open, onClose }: CookModeProps) {
  ...
  return (
    <div className="fixed inset-0 z-[200] bg-lattice-void flex flex-col">
      <header className="flex items-center gap-3 px-6 py-3 border-b border-white/10">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="text-xs text-gray-400 tabular-nums">Serves {servings} · Step {idx + 1} of {steps.length}</div>
        </div>
              ...
              {step.timerSec != null && step.timerSec > 0 && (
                <div className="mt-12 flex items-center gap-4">
                  <button
                    ...
                    className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-cyan-500 text-black font-bold hover:bg-cyan-400 text-xl tabular-nums"
                  >
